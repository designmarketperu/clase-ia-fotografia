...
<head>
  ...
  <title>Clase Intensiva: Edición y Mejora de Fotos con IA</title>
  ...
  <style>
    ...
    .header {
      background: linear-gradient(90deg, #725cff, #1de1c6);
      color: #fff;
    ...
    .container {
      ...
      background: #fff;
      border-radius: 16px;
      box-shadow: 0 8px 32px rgba(67,67,128,0.10), 0 1.5px 4px rgba(40,110,188,0.10);
      padding: 2rem 2.5rem;
    }
    h2 {
      margin-top: 2.2em;
...
<body>
  ...
  <div class="container">
    ...
    <h2>1. Introducción: El impacto real de la IA en la fotografía</h2>
    <ul>
    ...
    <h2>3. RunningHub/ComfyUI y Qwen.ai: Flujos avanzados y escaladores IA</h2>
    <ul>
